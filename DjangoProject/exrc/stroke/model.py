...
class StrokeModel:
    data = r"C:\Users\AIA\djangoProject\admin\data\stroke"
    save = r"C:\Users\AIA\djangoProject\admin\save\stroke"

    def __init__(self):
        self.stroke = pd.read_csv(r'C:\Users\AIA\MsaProject\DjangoProject\exrc\stroke\data\healthcare-dataset-stroke-data.csv')
        self.my_stroke = None
    ...
    def norminal(self):
        ...
        self.spec()
        print(" ### 프리프로세스 종료 ### ")
        self.stroke.to_csv(r"C:\Users\AIA\MsaProject\DjangoProject\exrc\stroke\save\stroke.csv", index=False)
    ...
    def set_target(self):
        df = pd.read_csv(r"C:\Users\AIA\MsaProject\DjangoProject\exrc\stroke\save\stroke.csv")  # Unnamed: 0 컬럼생성방지
